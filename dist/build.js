...
// module
exports.push([module.i, "body{margin:0;background-color:#f5f5f5;font-family:Roboto,sans-serif}.ai-window,.wrapper{max-width:500px;margin-left:auto;margin-right:auto}.ai-window{padding:1rem}.query{padding:16px 0;background-color:#fff;box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);z-index:999;position:fixed;width:100%}.queryform{border:0;width:80%;margin-left:45px;font-size:16px;outline:none;color:rgba(0,0,0,.8);font-weight:500}.wrapper:hover>.iicon{color:#0057e7}.iicon{margin-left:5px;position:absolute;color:rgba(0,0,0,.8)}.chat-window{width:100%}.bubble{width:auto;background-color:#e1e1e1;padding:16px;border-radius:8px;color:rgba(0,0,0,.8);float:right}.bubble.bot{background-color:#fff;float:left}td{margin-top:30px;margin-bottom:10px}.mdc-card{background-color:#fff}.openlink{font-size:16px;margin-left:5px}.mdc-card__media-item{height:auto;max-width:400px}.mdc-card__action{color:#0057e7}.chips{margin-left:-10px}.suggestion{margin-top:20px;float:left;margin-left:10px;padding:10px;border:2px solid rgba(0,0,0,.4);color:rgba(0,0,0,.4);border-radius:4px;cursor:pointer}.suggestion:active{border:2px solid #000;color:#000}.suggestion.link{color:#fff;background-color:#0057e7;border:2px solid #0057e7}.copyright{font-weight:600;color:rgba(0,0,0,.6)}.copyright a{text-decoration:none;color:#0057e7}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _c('br'), _vm._v(" "), _c('br'), _vm._v(" "), _vm._m(0)], 2)])
